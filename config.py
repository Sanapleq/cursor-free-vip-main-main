...
# Lazy import utils to avoid circular imports
def _get_utils_functions():
    """Lazy import utils functions to avoid circular imports"""
    from utils import get_user_documents_path, get_linux_cursor_path, get_default_driver_path, get_default_browser_path
    return get_user_documents_path, get_linux_cursor_path, get_default_driver_path, get_default_browser_path
...
class ConfigManager:
    ...
    def setup_config_directory(self) -> Tuple[str, str]:
        ...
        """
        # Lazy import utils
        get_user_documents_path, _, _, _ = _get_utils_functions()
    ...
    def get_default_config(self) -> Dict[str, Dict[str, Any]]:
        ...
        """
        # Lazy import utils
        get_user_documents_path, get_linux_cursor_path, get_default_driver_path, get_default_browser_path = _get_utils_functions()
